...
for eachaddress in datelist:
    ...
    if downloadtype==1 or downloadtype==2 or downloadtype==3 or downloadtype==4:
        ...
        filepathname=downloadpath2 + codenumber + '_' +dict[codenumber] +'_' + yearnumber.group(0) + filetypestr + '.pdf'  #+ filename
