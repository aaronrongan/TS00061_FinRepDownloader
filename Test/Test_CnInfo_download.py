...
#关键代码
    ...
    query_path=’http: // www.cninfo.com.cn / new / disclosure / stock?plate = sse & stockCode = 600036 & orgId = gssh0600036  #‘
    print(page, '*********')
...
spy_save("http://www.cninfo.com.cn/new/disclosure/stock?plate=sse&stockCode=600036&orgId=gssh0600036#")